...
if (!class_exists('GSF_Theme_Options')) {
	class GSF_Theme_Options
	{
		...
		{
			wp_enqueue_style(GSF_PLUGIN_RESOURCE_PREFIX . 'field-css', GSF_PLUGIN_URL . 'assets/css/field-css.css', array(), GSF_VER);
		}
		...
		public function admin_enqueue_scripts()
		{
			...
			wp_enqueue_script(GSF_PLUGIN_RESOURCE_PREFIX . 'field-config', GSF_PLUGIN_URL . 'assets/js/field-config.js', array(), GSF_VER, true);
			wp_enqueue_script(GSF_PLUGIN_RESOURCE_PREFIX . 'theme-options', GSF_PLUGIN_URL . 'assets/js/options.js', array(), GSF_VER, true);
			wp_localize_script(GSF_PLUGIN_RESOURCE_PREFIX . 'field-config', 'gsfMetaData', array(
