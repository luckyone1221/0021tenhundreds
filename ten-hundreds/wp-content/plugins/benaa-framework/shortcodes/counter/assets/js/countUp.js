...
jQuery(document).ready(function(){
    if ( 'undefined' !== typeof(jQuery.fn.waypoint) ) {
        jQuery('.g5plus-counter').waypoint(function () {
            jQuery(this).find('.counterup').each(function () {
                var start=jQuery(this).data('start');
                var end=jQuery(this).data('end');
                var decimals=jQuery(this).data('decimals');
                ...
                var decimal=jQuery(this).data('decimal');
