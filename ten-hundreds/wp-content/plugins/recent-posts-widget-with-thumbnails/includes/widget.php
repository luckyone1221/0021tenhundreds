        ...
        <ul>
            <?php while ($r->have_posts()) {
                ...
                ?>><a href="<?php the_permalink(); ?>"<?php echo $this->customs['link_target']; ?>><?php
                    ...
                    echo '<div class="WrapDateAutor">';
                    if ($bools['show_author']) {
                        ?>
                        <span class="rpwwt-post-author"><?php echo esc_html($this->get_the_author()); ?></span> | <?php
                    }
                    if ($bools['show_date']) {
                        ?>
                    ...
                    if (!$bools['hide_title']) {
                        ...
                        <a href="<?php the_permalink(); ?>">
                                                    <span class="rpwwt-post-title"><?php if ($post_title = $this->get_the_trimmed_post_title()) {
                                                            echo $post_title;
                                                        } else {
                                                            the_ID();
                                                        } ?></span>
