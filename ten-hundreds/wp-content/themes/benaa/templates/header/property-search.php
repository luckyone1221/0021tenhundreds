<?php
if ((!defined('ABSPATH')) || (!class_exists('Essential_Real_Estate'))) {
...
$css_class_field = 'col-lg-3 col-md-3 col-sm-4 col-xs-12';
$css_class_half_field = 'col-lg-3 col-md-3 col-sm-4 col-xs-12';

$css_class_header_field = 'col-lg-2 col-md-2 col-sm-4 col-xs-12';
$css_class_header_half_field = 'col-lg-2 col-md-2 col-sm-4 col-xs-12';
$field_number = 0;
					...
					<div class="form-search">
						<div class="header-search">
							<div class="row">
										...
										switch ($field) {
											...
											case 'property_address':
												ere_get_template('property/search-fields/property_address.php', array(
													'css_class_field' => 'col-lg-6 col-md-6 col-sm-8 col-xs-12',
											...
											case 'property_price':
												ere_get_template('property/search-fields/property_price.php', array(
													'css_class_field'      => 'col-lg-4 col-md-6 col-sm-8 col-xs-12',
													'css_class_half_field' => $css_class_header_half_field,
								...
								?>
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 form-group submit-search-form pull-right">
