...
if ($property_gallery):
    ...
    <!--sProdCard -->
    <div class="sProdCard__slider single-property-element property-gallery-wrap">
        <div class="ere-property-element">
            ...
            <div class="sProdCard__thumb single-property-image-thumb owl-carousel manual ere-carousel-manual">
                <?php
                foreach ($property_gallery as $image):
                    $image_src = ere_image_resize_id($image, 250, 130, true);
                    if (!empty($image_src)) { ?>
                        <div class="property-gallery-item sProdCard__thumb-img">
