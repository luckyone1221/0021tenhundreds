...
<div class="single-property-element property-reviews">
  <div class="ere-property-element">
    <div class="aggregate-rating sFeedBack__rating-cont" data-score="<?php echo round($rating, 2); ?>" itemscope
         itemtype="<?php echo ere_server_protocol(); ?>schema.org/AggregateRating">
      <div class="ratings-summary sFeedBack__rat-summ">
      ...
      <div class="overall-rating sFeedBack__o-rate">
    ...
    <h4
      class="reviews-count"><?php printf(_n('%s Review', '%s Reviews', $total_reviews, 'essential-real-estate'), $total_reviews); ?></h4>
